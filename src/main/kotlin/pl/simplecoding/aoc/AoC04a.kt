...
fun main(args: Array<String>) {
    val fileContent = AoCUtils.getFile(if (args.isNotEmpty()) args[0] else "aoc04a.txt")
    AoC04a.solve(fileContent).also { println(it) }
}
...
object AoC04a {
    ...
    data class Card(
        ...
        fun pointsForGame(pointCountingRule: (Int) -> Int): Int {
            val winningNumbersFound = cardNumbers
                .count { it in winningNumbers }

            return pointCountingRule(winningNumbersFound)
        }
    }
}